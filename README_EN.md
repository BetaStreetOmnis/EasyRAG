...
- Document Processing: Support for multiple document formats including PDF, Word, text, etc.
- Intelligent Retrieval: Precise content retrieval based on vector similarity
- Intelligent Q&A: Generate accurate answers by combining knowledge base content
- Local Deployment: All features run locally, ensuring data security
- DeepSeek Integration: Using DeepSeek 1.5B model to provide intelligent answers
